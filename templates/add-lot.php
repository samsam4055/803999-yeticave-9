    ...
    <form class="form form--add-lot container <?= $errors ? 'form--invalid' : ''; ?>" action="add.php" method="post"
        ...
        <div class="form__container-two">
            <div class="form__item <?= isset($errors['lot-name']) ? "form__item--invalid" : ""; ?>">
                ...
                <input id="lot-name" type="text" name="lot-name" value="<?= htmlspecialchars($saved_name); ?>"
        ...
        <div class="form__item form__item--wide <?= isset($errors['message']) ? "form__item--invalid" : ""; ?>">
            ...
            <textarea id="message" name="message" maxlength="1000"
                      placeholder="Напишите описание лота"><?= htmlspecialchars($saved_message); ?></textarea>
        ...
        <div class="form__container-three">
            <div class="form__item form__item--small <?= isset($errors['lot-rate']) ? 'form__item--invalid' : ''; ?>">
                ...
                <input id="lot-rate" type="text" name="lot-rate" value="<?= htmlspecialchars($saved_start_price); ?>"
                       placeholder="0">
                <span class="form__error"><?= $errors['lot-rate']; ?></span>
            </div>
            <div class="form__item form__item--small <?= isset($errors['lot-step']) ? 'form__item--invalid' : ''; ?>">
                <label for="lot-step">Шаг ставки <sup>*</sup></label>
                <input id="lot-step" type="text" name="lot-step" value="<?= htmlspecialchars($saved_step); ?>"
                       placeholder="0">
            ...
            <div class="form__item <?= isset($errors['lot-date']) ? 'form__item--invalid' : ''; ?>">
                ...
                <input class="form__input-date" id="lot-date" type="text" name="lot-date"
                       value="<?= htmlspecialchars($saved_date); ?>" placeholder="Введите дату в формате ГГГГ-ММ-ДД"
                       required>
