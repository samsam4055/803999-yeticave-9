<main>
    <nav class="nav">
        <ul class="nav__list container">
            <?php foreach ($categories as $category) : ?>
                <li class="nav__item <?= $category['name'] === $found_lots[0]['category'] ? 'nav__item--current' : ''; ?>">
    ...
    <div class="container">
        <section class="lots">
            <h2>Все лоты в категории <span>«<?= esc($found_lots[0]['category']); ?>»</span></h2>
            <ul class="lots__list">
                    ...
                    <li class="lots__item lot">
                        ...
                        <div class="lot__info">
                            ...
                            <h3 class="lot__title"><a class="text-link"
                                                      href="lot.php?id=<?= $found_item['id']; ?>"><?= esc($found_item['name']); ?></a>
                            </h3>
                            <div class="lot__state">
                                <div class="lot__rate">
                                    ...
                                    <span class="lot__cost"><?= $found_item['amount'] ? format_price($found_item['amount']) : format_price($found_item['start_price']); ?><b
                                                class="rub">р</b></span>
                                </div>
